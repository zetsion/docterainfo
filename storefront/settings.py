...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': 'dttmf74ie',
    'API_KEY': '252195551666353',
    'API_SECRET': 'w3pRn3TvAkUvpUeG57w-NsnEafE',
}
...
if ENVIRONMENT == 'production':
    # Use Cloudinary or other cloud media storage
    ...
    # Use local media files (for local development)
    MEDIA_URL = '/media/'
